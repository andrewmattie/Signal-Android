...
public class ContactAvatar implements Parcelable, Json {
  ...
  public JSONObject toJson() throws JSONException {
    if (image.getDataUri() == null) {
      throw new IllegalStateException("Serializing as JSON is only possible if the attachment has a URI available.");
    }

    JSONObject object = new JSONObject();
    object.put("image", image.getDataUri().toString());
